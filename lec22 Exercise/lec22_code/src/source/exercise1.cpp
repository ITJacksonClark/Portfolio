// A crate with lighting covers the whole crate
...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/lighting_maps_ex1.vert", "../../src/shader/lighting_maps_ex1.frag");
	lampShader = loadShader("../../src/shader/lamp_ex1.vert", "../../src/shader/lamp_ex1.frag");
