// A crate with lighting where the edges
// are multicolored when light shines on them
...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/lighting_maps_ex2.vert", "../../src/shader/lighting_maps_ex2.frag");
	lampShader = loadShader("../../src/shader/lamp_ex2.vert", "../../src/shader/lamp_ex2.frag");
	...
	specularMap = loadTexture("../../src/resources/textures/lighting_maps_specular_color.png");
